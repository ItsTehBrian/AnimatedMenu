...
public abstract class PluginCurrency<N extends Number & Comparable<N>> {
    ...
    /*TODO public static final PluginCurrency<Integer> PLAYER_POINTS = new PluginCurrency<Integer>() {
        PlayerPointsAPI api;
    ...
    /*TODO public static final PluginCurrency<Integer> GEMS = new PluginCurrency<Integer>() {
    ...
    /*TODO public static final PluginCurrency<Double> COINS = new PluginCurrency<Double>() {
